        ...
        <div class="box">
            <div class="box-body">
                <table class="table table-bordered" width="100%">
                    ...
                    <tr>
                        <th scope="col" colspan="5" style="color: #ff0000"><p style="font-size: 14pt">BCH ĐOÀN {{strtoupper($group_name)}}</p></th>
                        <th scope="col" colspan="1"></th>
                        ...
                        @foreach ($result as $k => $item)
                            @if($item->parent_id == $key)
                                ...
                                <tr>
                                    ...
                                    @if($h == 1)
                                        <td scope="col" rowspan="{{$data[$key]}}" style="border: 1px solid #000000; border-collapse: collapse;  "><p style="font-size: 12pt">{{$value}}</p></td>
                                    @endif
                                </tr>
